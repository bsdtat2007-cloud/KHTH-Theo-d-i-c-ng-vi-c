...
import { Plus, X, ChevronDown, Search, Trash2, Pencil, Check, ListTodo, CircleDot, CheckCircle2, AlertCircle, ShieldCheck, User, LogOut, PlayCircle, Archive, ArchiveRestore, Bell, Table2, Calendar, Mail, ChevronLeft, ChevronRight, LayoutGrid, ClipboardList, ChevronRight as ChevronRightSmall } from 'lucide-react';
...
const CATALOG_CV = [
  { ma: '1.1', nhom: '01', ten: 'Danh mục kỹ thuật', noiDung: 'Quản lý DMKT; cập nhật tên kỹ thuật theo quy định; tiếp nhận đăng ký kỹ thuật mới; lập hồ sơ đăng ký kỹ thuật mới; theo dõi cập nhật danh mục theo quy định hiện hành' },
  { ma: '1.2', nhom: '01', ten: 'Phác đồ điều trị', noiDung: 'Quản lý hệ thống phác đồ; tiếp nhận đề xuất; rà soát, cập nhật; tổ chức thông qua HĐKHKT; cập nhật phác đồ' },
  { ma: '1.3', nhom: '01', ten: 'Quy trình kỹ thuật', noiDung: 'Quản lý quy trình kỹ thuật; tiếp nhận đề xuất mới/sửa đổi; rà soát; trình HĐKHKT; cập nhật định kỳ' },
  { ma: '1.4', nhom: '01', ten: 'Phẫu thuật - thủ thuật', noiDung: 'Quản lý danh mục; tiếp nhận đăng ký PTTT của bác sĩ; tổng hợp; báo cáo' },
  { ma: '1.5', nhom: '01', ten: 'Hồ sơ hành nghề chuyên môn', noiDung: 'Quản lý, theo dõi và lưu trữ chứng chỉ hành nghề / các chứng chỉ liên quan' },
  { ma: '1.6', nhom: '01', ten: 'Quản lý chất lượng thuộc phạm vi KHTH', noiDung: 'Theo dõi các tiêu chí được phân công; chỉ số chất lượng; phối hợp cải tiến; tổng hợp kết quả' },
  { ma: '1.7', nhom: '01', ten: 'Quy trình chuyên môn', noiDung: 'Xây dựng Quy trình chuyên môn; kiểm tra thực hiện quy trình chuyên môn; kiểm tra đột xuất HSBA; tổng hợp tồn tại; đề xuất khắc phục' },
  { ma: '1.8', nhom: '01', ten: 'Xếp cấp chuyên môn', noiDung: 'Quản lý hồ sơ; rà soát điều kiện; theo dõi cập nhật; lưu hồ sơ' },
  { ma: '1.9', nhom: '01', ten: 'Tiếp dân - phản ánh chuyên môn', noiDung: 'Tiếp nhận thông tin; rà soát nội dung và quy định; phối hợp xác minh; báo cáo lãnh đạo; theo dõi xử lý' },
  { ma: '1.10', nhom: '01', ten: 'KCB nhân đạo', noiDung: 'Lập kế hoạch; hồ sơ xin phép; tổ chức; báo cáo; lưu trữ' },
  { ma: '1.11', nhom: '01', ten: 'Khám sức khỏe - KSK lái xe', noiDung: 'Quản lý hồ sơ; theo dõi hoạt động; cập nhật dữ liệu theo quy định; báo cáo' },
  { ma: '1.12', nhom: '01', ten: 'Hợp đồng gửi mẫu', noiDung: 'Tiếp nhận nhu cầu; xây dựng hợp đồng; theo dõi thực hiện; quản lý, lưu trữ hợp đồng' },
  { ma: '2.1', nhom: '02', ten: 'Kế hoạch hoạt động, theo dõi thực hiện kế hoạch', noiDung: 'Kế hoạch năm, quý, tháng; kế hoạch theo đợt/chuyên đề; kế hoạch của Phòng; kế hoạch cấp Bệnh viện. Theo dõi tiến độ; nhắc việc; tổng hợp kết quả; báo cáo khó khăn/tồn tại' },
  { ma: '2.2', nhom: '02', ten: 'Thống kê hoạt động bệnh viện, báo cáo định kỳ', noiDung: 'Thu thập số liệu; kiểm tra; tổng hợp; phân tích; quản lý dữ liệu. Báo cáo tuần/tháng/quý/6 tháng/năm theo yêu cầu về Sở Y tế' },
  { ma: '2.3', nhom: '02', ten: 'Báo cáo bệnh truyền nhiễm - bệnh không lây', noiDung: 'Tổng hợp; kiểm tra; báo cáo; lưu trữ số liệu' },
  { ma: '3.1', nhom: '03', ten: 'Y chứng', noiDung: 'Tiếp nhận yêu cầu; lấy HSBA; liên hệ đơn vị chuyên môn; kiểm tra; trình ký; trả kết quả; lưu hồ sơ' },
  { ma: '3.2', nhom: '03', ten: 'Ấn phẩm', noiDung: 'Thầu ấn phẩm; quản lý cấp phát' },
  { ma: '3.3', nhom: '03', ten: 'Hồ sơ bệnh án giấy', noiDung: 'Tiếp nhận HSBA; kiểm tra; phân loại; lưu trữ; quản lý kho; khai thác HSBA; tổ chức hủy HSBA; lưu hồ sơ' },
  { ma: '3.4', nhom: '03', ten: 'Văn thư - hành chính nội bộ Phòng', noiDung: 'Công văn đến; chấm công; lưu tài liệu chuyên môn; văn phòng phẩm; tài sản; quản lý loại viên chức; lịch trực' },
  { ma: '3.5', nhom: '03', ten: 'KPI - Thi đua khen thưởng, quản lý 5S phòng', noiDung: 'Quản lý KPI, thi đua khen thưởng. Kiểm tra, đánh giá, quản lý 5S phòng' },
  { ma: '4.1', nhom: '04', ten: 'Cập nhật biểu mẫu - Tập huấn - Văn bản pháp quy BHYT', noiDung: 'Theo dõi văn bản mới; cập nhật; phân tích ảnh hưởng; triển khai/tập huấn' },
  { ma: '4.2', nhom: '04', ten: 'Giám định - thẩm định - thanh tra BHYT', noiDung: 'Giám sát việc thực hiện quy định; phát hiện lỗi; hướng dẫn khắc phục. Lập kế hoạch tiếp đoàn; chuẩn bị hồ sơ; điều phối giải trình; tổng hợp nội dung; theo dõi khắc phục; theo dõi kết quả; giao đơn vị giải trình; tổng hợp báo cáo lãnh đạo' },
  { ma: '4.3', nhom: '04', ten: 'Hợp đồng KCB BHYT', noiDung: 'Chuẩn bị hồ sơ và phụ lục; cập nhật danh mục; đăng ký khám chữa bệnh BHYT trực tuyến' },
  { ma: '4.4', nhom: '04', ten: 'Dữ liệu KCB BHYT', noiDung: 'Người hành nghề; tăng giảm người hành nghề; dữ liệu trên cổng dữ liệu BHYT trực tuyến' },
  { ma: '5.1', nhom: '05', ten: 'Đào tạo ngắn hạn', noiDung: 'Xây dựng kế hoạch, chương trình; tổ chức lớp học; theo dõi; báo cáo; lưu hồ sơ' },
  { ma: '5.2', nhom: '05', ten: 'Quản lý sinh viên/học viên của Trường', noiDung: 'Tiếp nhận; phân bố; theo dõi; quản lý SV/HV Việt Nam; người nước ngoài; quản lý hội trường' },
  { ma: '5.3', nhom: '05', ten: 'Tiếp nhận chuyển giao kỹ thuật', noiDung: 'Hồ sơ đăng ký; liên hệ đơn vị chuyển giao; xây dựng hợp đồng; tổ chức tiếp nhận; theo dõi; báo cáo; lưu trữ; triển khai; đánh giá; cấp chứng nhận' },
  { ma: '5.4', nhom: '05', ten: 'Hợp tác chuyên môn y tế', noiDung: 'Tiếp nhận đề xuất; xây dựng hợp đồng nguyên tắc; theo dõi thực hiện đến hạn' },
  { ma: '6.1', nhom: '06', ten: 'Nghiên cứu khoa học', noiDung: 'Kế hoạch NCKH; thông báo; tiếp nhận đề tài; hồ sơ lấy mẫu; hội đồng; xác nhận lấy mẫu; nghiệm thu; quản lý hồ sơ' },
  { ma: '6.2', nhom: '06', ten: 'Thử nghiệm lâm sàng', noiDung: 'Hồ sơ gửi cơ quan quản lý; tiếp nhận hồ sơ; triển khai; theo dõi; báo cáo, lưu trữ' },
  { ma: '6.3', nhom: '06', ten: 'Đạo đức trong nghiên cứu y sinh học', noiDung: 'Tiếp nhận; rà soát hồ sơ; chuẩn bị tài liệu Hội đồng; lịch họp; tổ chức họp; biên bản; văn thư; lưu trữ' },
  { ma: '7.1', nhom: '07', ten: 'Hợp tác quốc tế', noiDung: 'Kế hoạch; hồ sơ pháp lý; đoàn vào; đoàn ra; tổ chức hoạt động hợp tác; theo dõi tiến độ hợp tác; báo cáo' },
  { ma: '7.2', nhom: '07', ten: 'Hội nghị - hội thảo khoa học, sinh hoạt chuyên môn', noiDung: 'Tiếp nhận đề xuất; lập kế hoạch; hồ sơ pháp lý; tổ chức; điều phối; báo cáo; lưu trữ' },
  { ma: '8.1', nhom: '08', ten: 'Hồ sơ bệnh án điện tử - EMR', noiDung: 'Xây dựng quy trình; biểu mẫu; triển khai; theo dõi; rà soát; tổng hợp báo cáo; lưu trữ' },
  { ma: '8.2', nhom: '08', ten: 'Khám chữa bệnh từ xa, ERAS, mô hình/chương trình chuyên môn mới', noiDung: 'Lập kế hoạch; tổ chức; theo dõi; báo cáo; lưu hồ sơ' },
];
    ...
    <div style={{minHeight:'100vh', background:BG, fontFamily:"'Inter', -apple-system, sans-serif", color:'#20242B', paddingBottom: 60}}>
      ...
      <div style={{padding:'18px 16px', maxWidth: isAdmin ? 1080 : 920, margin:'0 auto', display:'flex', gap:16, alignItems:'flex-start'}}>
        ...
        {showArchive ? (
          ...
          <CatalogView onAssign={(item) => {
            setCatalogPrefill({ ten: item.ten, nhom: item.nhom });
            setEditingId(null);
            setShowForm(true);
          }}/>
...
function AdminSidebar({ current, archiveCount, pendingCount, onSelect }) {
  const items = [
    ...
    { key: 'catalog', icon: <ClipboardList size={16}/>, label: 'Danh mục CV' },
...
function CatalogView({ onAssign }) {
  const [search, setSearch] = useState('');
  const [filterNhom, setFilterNhom] = useState('all');

  const filtered = CATALOG_CV.filter(item => {
      ...
      {grouped.length === 0 ? (
        ...
        grouped.map(g => (
          <div key={g.nhom.ma} className="card" style={{overflow:'hidden', marginBottom:12}}>
            ...
            {g.items.map(item => (
              <div key={item.ma} style={{padding:'12px 14px', borderTop:'1px solid #F0EDE3', display:'flex', gap:10, alignItems:'flex-start'}}>
                <div style={{flex:1, minWidth:0}}>
                  <div style={{fontSize:13, fontWeight:700, color:'#20242B'}}>
                    <span style={{color:SKY_DEEP, marginRight:6}}>{item.ma}</span>{item.ten}
                  </div>
                  <div style={{fontSize:11.5, color:'#6b6258', marginTop:4, lineHeight:1.5}}>{item.noiDung}</div>
                </div>
                <button className="btn" onClick={()=>onAssign(item)}
                  style={{display:'flex', alignItems:'center', gap:5, background:NAVY, color:'#fff', padding:'7px 11px', borderRadius:8, fontSize:11.5, fontWeight:700, flexShrink:0, whiteSpace:'nowrap'}}>
                  <Plus size={13}/> Giao việc
                </button>
              </div>
            ))}
